...
def login_orcid():
    return redirect('https://orcid.org/oauth/authorize?client_id=***REMOVED***&response_type=code&scope=/authenticate&redirect_uri=http://www.usap-dc.org/authorized_orcid')
...
def authorized_orcid():
    ...
    p = requests.post('https://orcid.org/oauth/token', data={'client_id':'***REMOVED***', 'client_secret':'***REMOVED***','grant_type':'authorization_code','code':code,'redirect_uri':'http://www.usap-dc.org/authorized_orcid'}, headers={'accept': 'application/json'}).json()
